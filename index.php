        ...
        <div class="row">
            <div class="col-sm-12">
                <nav class="navbar navbar-expand-sm navbar-dark fixed-top" style="background-image:linear-gradient(to right, blue,purple)">
                    ...
                    <button class="navbar-toggler d-lg-none" type="button" data-toggle="collapse" data-target="#collapsibleNavId" aria-controls="collapsibleNavId" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-arrow-circle-down" aria-hidden="true"></i></button>
            ...
            <div class="col-sm-12">
                    ...
                    <div class="item">
                        <div class="jumbotron jumbotron-fluid">
                            <div class="container">
                                ...
                                <p>Embark on a unique adventure in this themed room.</p>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="jumbotron jumbotron-fluid">
                            <div class="container">
                                ...
                                <p>Indulge in luxury and elegance in this deluxe room.</p>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="jumbotron jumbotron-fluid">
                            <div class="container">
                                ...
                                <p>Stay productive and comfortable in this room</p>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                ...
                <div class="food owl-carousel">
                    ...
                    <div class="item">
                        <div class="jumbotron jumbotron-fluid">
                            <div class="container">
                                ...
                                <p>
                                    Experience the vibrant flavors of our freshly squeezed juices</p>
                            </div>
                        </div>
                    </div>
                    <!-- item2 -->
                    <div class="item">
                        <div class="jumbotron jumbotron-fluid">
                            <div class="container">
                                ...
                                <p>Enjoy the best drinks from us,drinks that makes you live longer</p>
                            </div>
                        </div>
                    </div>
                    <!-- item3 -->
                    <div class="item">
                        <div class="jumbotron jumbotron-fluid">
                            <div class="container">
                                ...
                                <p>
                                    Discover the art of mixology with our signature cocktails daily.</p>
                            </div>
                        </div>
                    </div>
                    <!-- item4 -->
                    <div class="item">
                        <div class="jumbotron jumbotron-fluid">
                            <div class="container">
                                <img class="img-fluid" src="./assets/images/hotel/foods/chapo.jpg" alt="">
                                <de>Enjoy a delicious Meal </p>
                            </div>
                        </div>
                    </div>
